...
class WorkerNodesOptions {
    constructor({
        ...
        if (workerType !== "thread" && Object.keys(resourceLimits).length > 0) {
            throw new Error(`resourceLimits can only be used with workerType: thread`);
        }

        /**
         * Gives you a choice of the worker implementation - either "thread" or "process"
         * 
         * @type {string}
         */
