...
test('should be exposed as a function named call', t => {
    // given
    const workerNodes = new WorkerNodes(fixture('echo-function-sync'));
...
test('should support single, asynchronous function', async t => {
    // given
    const workerNodes = new WorkerNodes(fixture('echo-function-async'));
...
test('should support module that exports multiple functions', async t => {
    // given
    const workerNodes = new WorkerNodes(fixture('echo-module-callable'));
...
test('should retain this context of the module methods', async t => {
    // given
    const workerNodes = new WorkerNodes(fixture('echo-module-plain'));
